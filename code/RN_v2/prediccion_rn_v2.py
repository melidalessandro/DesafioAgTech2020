...
df_final.loc[~pd.isna(df_final['CultivoId_y']), 'CultivoId_x'] = df_final.loc[
    ~pd.isna(df_final['CultivoId_y']), 'CultivoId_y']
...
df_rf_viejo.loc[pd.isna(df_rf_viejo['CultivoId_y']), 'CultivoId_y'] = df_rf_viejo.loc[
    pd.isna(df_rf_viejo['CultivoId_y']), 'CultivoId_x']
